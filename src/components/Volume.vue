<template>
  <div>
    <div v-if="isVolumeOn" @click="toggleVolumeModal" class="fixed bottom-0 right-0 p-8 text-blue-400 hover:text-blue-200 cursor-pointer">
    ...
    <div v-else @click="toggleVolumeModal" class="fixed bottom-0 right-0 p-8 text-blue-400 hover:text-blue-200 cursor-pointer">
